...
{
    class FriendRequestScreenOutputAdapter : AScreenOutputAdapter
    {
            ...
            MessageToSend ms)
        {
                ...
                i++)
            {
                ...
                ms.Append(" ");
                ms.Append(createMessageLink(MENU_LINK_NAME, "[+]", "APPROVE_" + an_option.display_text));
                ms.Append(" ");
                ms.Append(createMessageLink(MENU_LINK_NAME, "[-]", "REJECT_" + an_option.display_text));
                ms.Append(" ");
                ms.Append("\r\n");
                count++;
            }
