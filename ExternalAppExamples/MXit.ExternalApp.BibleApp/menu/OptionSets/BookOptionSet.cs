...
namespace MxitTestApp
{
    class BookOptionSet : AMenuDynamicOptionSet
    {
        ...
        public override string parseInput(String input, UserSession us)
        {
            ...
            string test_id = (String)us.getVariable("Testament_Handler.testament_id");
            if (test_id == "1")
                starting_index += 39;
